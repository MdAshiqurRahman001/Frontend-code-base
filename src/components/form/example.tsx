...
export default function ProfileFormExample() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 border rounded-xl shadow-sm bg-card">
      <h2 className="text-xl font-semibold mb-4 text-card-foreground">Profile Form Example</h2>
