...
export function NRTable<TData, TValue>({
  ...
  return (
    <div className="my-5 w-full overflow-hidden rounded-xl border border-border/50 bg-card">
      <Table>
            ...
            table.getRowModel().rows.map((row) => (
              ...
              >
                {row.getVisibleCells().map((cell) => (
                  <TableCell className="py-4 text-foreground text-sm" key={cell.id}>
